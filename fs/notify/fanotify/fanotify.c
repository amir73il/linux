				 ...
				 struct fsnotify_iter_info *iter_info)
{
	...
	BUILD_BUG_ON(FAN_MODIFY_PERM != FS_MODIFY_PERM);
	BUILD_BUG_ON(FAN_ATTRIB_PERM != FS_ATTRIB_PERM);
	BUILD_BUG_ON(FAN_CREATE_PERM != FS_CREATE_PERM);
	BUILD_BUG_ON(FAN_DELETE_PERM != FS_DELETE_PERM);
	BUILD_BUG_ON(FAN_RENAME_PERM != FS_RENAME_PERM);
	...
	BUILD_BUG_ON(HWEIGHT32(ALL_FANOTIFY_EVENT_BITS) != 27);
