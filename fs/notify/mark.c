					...
					struct fsnotify_mark_connector *conn)
{
	...
	/*
	 * If the highest priorty of group watching this object is prio,
	 * then watched object has a referene on counters [0..prio].
	...
	for (unsigned int p = highest_prio; p > conn->prio; p--)
