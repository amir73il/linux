...
static inline void fsnotify_inode(struct inode *inode, __u64 mask)
{
...
static inline int fsnotify_parent(struct dentry *dentry, __u64 mask,
 ...
 * is on a file/dentry.
 */
static inline void fsnotify_dentry(struct dentry *dentry, __u64 mask)
{
	fsnotify_parent(dentry, mask, dentry, FSNOTIFY_EVENT_DENTRY);
}

static inline int fsnotify_path(const struct path *path, __u64 mask)
{
