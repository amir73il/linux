...
extern bool fsnotify_recalc_mask(struct fsnotify_mark_connector *conn);
/* Recalculate mask and update children dentry flags if needed */
extern void fsnotify_recalc_mask_and_update_children(
