...
#define ALL_FSNOTIFY_READ_EVENTS (FS_ACCESS | FS_ACCESS_PERM | \
				  FS_LOOKUP_PERM | FS_CLOSE_NOWRITE)

#define IS_FSNOTIFY_READ_EVENT(mask) \
	((mask) & ALL_FSNOTIFY_READ_EVENTS)
...
extern void fsnotify_wait_handle_events(void);
