...
struct fsnotify_group {
	...
	struct user_namespace *user_ns;	/* user ns where group wasa created */
...
struct fsnotify_iter_info {
	struct super_block *sb;	/* Filter userns marks by sb */
...
#define FSNOTIFY_MARK_FLAG_USERNS_SB		0x08
...
extern void fsnotify_userns_delete(struct user_namespace *userns);
extern void fsnotify_idmapped_delete(struct user_namespace *userns,
				     struct super_block *sb);
...
static inline void fsnotify_idmapped_delete(struct user_namespace *userns,
					    struct super_block *sb)
{}
