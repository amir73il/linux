 ...
 * FS_NAME_INTENT overloads deprecated FS_DIR_MODIFY (similar meaning).
 * FS_MOVE_INTENT overloads fanotify FS_MNT_ATTACH (for mntns mark).
 * FS_MODIFY_INTENT overloads fanotify FS_MNT_DETTACH (for mntns mark).
 */
#define FS_NAME_INTENT		0x00080000	/* Subfile about to be linked/unlinked */
#define FS_MOVE_INTENT		0x01000000	/* Subfile about to be moved */
#define FS_MODIFY_INTENT	0x02000000	/* File about to be modified */
...
#define ALL_FSNOTIFY_INTENT_EVENTS (FS_NAME_INTENT | FS_MOVE_INTENT | \
				    FS_MODIFY_INTENT)
